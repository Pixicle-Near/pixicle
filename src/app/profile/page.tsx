...
function Profile() {
  const { wallet, nfts, isAuth } = useContext(MarketContext);
      ...
      <main>
        ...
        >
          ...
          >
            ...
            Toast. Doodles come in a joyful range of colors, traits and sizes
            with a collection size of 10,000. Each Doodle allows its owner to
            vote for experiences and activations paid for by the Doodles
            Community Treasury.
          </Text>
          {/* {User Stats} */}
          <HStack
